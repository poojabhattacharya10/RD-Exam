...
const routes = [
  {
    path: '/branch/create',
    name: 'BranchCreate',
    component: () => import('@/components/branch/BranchCreate.vue'),
  },
  {
    path: '/branch/edit/:id',
    name: 'BranchEdit',
    component: () => import('@/components/branch/BranchEdit.vue'),
  },
  {
    path: '/branch/list',
    name: 'BranchList',
    component: () => import('@/components/branch/BranchList.vue'),
  },
  {
    path: '/course/create',
    name: 'CourseCreate',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/exam/quesions/uplaod/:id',
        name: 'Qustion Upload',
        component: () => import('@/views/exam/questionupload.vue'),
      },
      {
        path: '/exam/view/quesions/:id',
        name: 'Qustion View',
        component: () => import('@/views/exam/viewquestion.vue'),
      },
      {
        path: '/theme',
        name: 'Theme1',
